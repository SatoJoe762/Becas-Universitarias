 ...
 * @author Manferuz
 */
public class e_Problemas3 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnMostrarEstudiantesSinBeca = new javax.swing.JButton();
        ...
        jLabel29.setText("3. Contar y Mostrar a todos los estudiantes que no cumplan los requisitos de Beca");
        ...
        btnMostrarEstudiantesSinBeca.setBackground(new java.awt.Color(13, 71, 161));
        btnMostrarEstudiantesSinBeca.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnMostrarEstudiantesSinBeca.setForeground(new java.awt.Color(255, 255, 255));
        btnMostrarEstudiantesSinBeca.setText("Estudiantes sin Beca");
        btnMostrarEstudiantesSinBeca.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnMostrarEstudiantesSinBeca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMostrarEstudiantesSinBecaActionPerformed(evt);
            }
        });
            ...
            .addGroup(ContentProblemasLayout.createSequentialGroup()
                .addGroup(ContentProblemasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ContentProblemasLayout.createSequentialGroup()
                        ...
                        .addGap(296, 296, 296)
                        .addComponent(btnMostrarEstudiantesSinBeca)
    ...
    private void btnMostrarEstudiantesSinBecaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarEstudiantesSinBecaActionPerformed
      // Obtener la lista de estudiantes sin requisitos de beca
        String resultado = mostrarEstudiantesSinRequisitos();

        // Mostrar el resultado en el JTextArea
        txtResultado.setText(resultado);
    }//GEN-LAST:event_btnMostrarEstudiantesSinBecaActionPerformed
    private String mostrarEstudiantesSinRequisitos() {
        ...
        for (int i = 0; i < universidad.getContadorCarreras(); i++) {
            ...
            for (int j = 0; j < c.getContadorEst(); j++) {
                Estudiante est = estudiantes[j];
                if (est.getPromedio() <= 69) {
                    total++;
                    sb.append("- ").append(est.getNombre())
                            .append(" (promedio: ").append(est.getPromedio()).append("), carrera: ")
                            .append(c.getNombreCarrera()).append("\n");
                }
            }
        }

        // Si no hay estudiantes con promedio <= 69
        if (total == 0) {
            sb.append("No hay estudiantes con promedio <= 69.\n");
        }
    ...
    private javax.swing.JButton btnMostrarEstudiantesSinBeca;
