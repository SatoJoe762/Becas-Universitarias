 ...
 * @author Manferuz
 */
public class e_Problemas2 extends javax.swing.JPanel {
    ...
    public e_Problemas2() {
        ...
        cargarComboBox(); // Cargar estudiantes en el JComboBox
    ...
    private void initComponents() {
        ...
        btnContarBecas = new javax.swing.JButton();
        ...
        jLabel29.setText("2. Contar y Mostrar las becas que podría recibir el estudiante x:");
        ...
        lblEstudiante.setText("Seleccione a un Estudiante:");
        ...
        btnContarBecas.setBackground(new java.awt.Color(13, 71, 161));
        btnContarBecas.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnContarBecas.setForeground(new java.awt.Color(255, 255, 255));
        btnContarBecas.setText("Becas que podría adquirir");
        btnContarBecas.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnContarBecas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnContarBecasActionPerformed(evt);
            }
        });
    ...
    private void btnContarBecasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContarBecasActionPerformed
         String nombreEst = (String) cmbEstudiantes.getSelectedItem();

        // Contar y obtener las becas que puede adquirir el estudiante
        String resultado = contarBecasEstudiante(nombreEst);

        // Mostrar el resultado en el JTextArea
        txtResultado.setText(resultado);


    }//GEN-LAST:event_btnContarBecasActionPerformed
    // Método para contar y mostrar las becas que puede adquirir el estudiante X
    private String contarBecasEstudiante(String nombreEst) {
        ...
        if (contador == 0) {
            return "Estudiante " + e.getNombre()
                    + " no puede adquirir ninguna beca (promedio " + e.getPromedio() + ")";
        } else {
            return "Estudiante " + e.getNombre()
    ...
    private Estudiante buscarEstudiante(String nombreEst) {
        for (int i = 0; i < universidad.getContadorCarreras(); i++) {
            Estudiante[] estudiantes = universidad.getCarreras()[i].getEstudiantes();
            for (int j = 0; j < universidad.getCarreras()[i].getContadorEst(); j++) {
                if (estudiantes[j].getNombre().equals(nombreEst)) {
    ...
    private javax.swing.JButton btnContarBecas;
